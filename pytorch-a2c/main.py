...
parser.add_argument('--num-steps', type=int, default=10, metavar='NS',
...
parser.add_argument('--max-episode-length', type=int, default=10, metavar='M',
...
if __name__ == '__main__':
    ...
    itr = 0
    while itr < 100000/args.num_updates:

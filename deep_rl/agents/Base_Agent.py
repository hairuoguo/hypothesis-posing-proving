...
#        self.total_episode_score_so_far += self.reward
        # so that the logger logs the number of steps taken.
    ...
    def save_max_result_seen(self):
        ...
        # make less than so that faster solves are recorded
...
#        if self.rolling_results[-1] > self.max_rolling_score_seen:
    ...
    def update_learning_rate(self, starting_lr,  optimizer):
        print('updating learning rate, beware')
    ...
    def create_NN(self, input_dim, output_dim, key_to_use=None, override_seed=None, hyperparameters=None):
        ...
        if hyperparameters['net_type'] == 'FC2':
            ...
            raise ValueError('invalid net_type hyperparameter: {}'
                    .format(self.hyperparameters['net_type']))
